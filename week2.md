...
점수를 입력받아  
90 이상 A, 80 이상 B, 나머지 C를 반환하는 함수 작성
...
문장을 입력받아 글자 수와 단어 개수를 출력하시오.

---

## 연습 문제 7

문장에 "AI"라는 단어가 포함되어 있는지 확인하시오.
